	...
	$.widget("ui.triggeredAutocomplete", $.extend(true, {}, $.ui.autocomplete.prototype, {
		...
		_create:function() {
			...
			this.options.select = function(event, ui) {
				...
				//this.value = start + self.options.trigger+ui.item.label+' ' + end; // ESTO ES LO ORIGINAL
				// ESTO ES MIO //
				var nuevoItem = ui.item.label;
				nuevoItem = nuevoItem.split(" ");
				nuevoItem = nuevoItem[0];				
				this.value = start + self.options.trigger+ nuevoItem +' ' + end;
				// HASTA AQUI //
